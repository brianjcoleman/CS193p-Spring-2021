...
struct EmojiArtDocumentView: View {
    ...
    @SceneStorage("EmojiArtDocumentView.steadyStateZoomScale") private var steadyStatePanOffset: CGSize = CGSize.zero
...
struct EmojiArtDocumentViewDemo: View {
